/* Proxy for compact Explore index meta:
 * /api/explore/static/<net>/index/meta -> ${FEED_STATIC_BASE}/<net>/index/meta.json
 */
...
export default async function handler(req, res) {
  try {
    ...
    const url = `${String(base).replace(/\/+$/, '')}/${encodeURIComponent(net)}/index/meta.json`;
