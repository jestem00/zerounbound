...
const META = {
  ...
  append_artifact_uri      : { label: 'Replace Artifact',             comp: 'AppendArtifactUri',         group: 'Metadata Ops' },
  append_extrauri          : { label: 'Replace ExtraUri',             comp: 'AppendExtraUri',            group: 'Metadata Ops' },
  clear_uri                : { label: 'ClearUri',                     comp: 'ClearUri',                  group: 'Metadata Ops' },
