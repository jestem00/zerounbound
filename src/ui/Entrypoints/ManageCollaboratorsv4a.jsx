/*─────────────────────────────────────────────────────────────
  ...
  Rev :    r717   2025-06-27
  Summary: v4a collaborators manager (set<address>)
──────────────────────────────────────────────────────────────*/
...
export default function ManageCollaboratorsv4a({
  ...
  const load = useCallback(async ()=>{
    ...
    try{
      ...
      if(typeof st.collaborators?.forEach==='function'){
        const tmp=[]; st.collaborators.forEach(a=>tmp.push(a)); return setList(tmp);
      }
  ...
  const remove = async (addr)=>{
    ...
    try{
      ...
      snack('Removing…','info'); await op.confirmation();
